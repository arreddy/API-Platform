...
public class MockController {
    ...
    /**
     * Mock any path under /mock/{proxyId}/**
     * Optional query param ?__status=201 to control response status.
     */
    ...
    public ResponseEntity<Object> mockProxy(
        ...
        MockGeneratorService.MockResponse result = generator.generate(
                oasDoc, request.getMethod(), mockPath, statusCode);
    ...
    public ResponseEntity<Object> mockInline(@RequestBody InlineRequest req) {
        ...
        MockGeneratorService.MockResponse result = generator.generate(req.oasDocument(), req.method(), req.path(), status);
