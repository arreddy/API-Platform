...
public class ApiKeyDto {
    ...
    public record Summary(
            String id, String name, String keyPrefix, String proxyId,
            List<String> scopes, int rateLimit, String rateLimitWindow,
            String status, OffsetDateTime lastUsedAt, OffsetDateTime expiresAt, OffsetDateTime createdAt
    ) {
        public static Summary from(ApiKey k) {
            return new Summary(k.getId(), k.getName(), k.getKeyPrefix(), k.getProxyId(),
                    k.getScopes() != null ? Arrays.asList(k.getScopes()) : List.of(),
                    k.getRateLimit(), k.getRateLimitWindow(), k.getStatus(),
    ...
    public record ValidationResult(
            boolean valid, String keyId, String tenantId,
