...
@SpringBootTest(
    ...
    classes = {ApiController.class, GlobalExceptionHandler.class})
...
class ApiControllerTest {
  ...
  @MockitoBean ApiRegistryService apiService;
  @MockitoBean OasAnalysisService oasAnalysisService;
  @MockitoBean OasValidatorService oasValidatorService;
